...
//---------- Playlist
const music = new Audio('../../Media/Remix/Thereon/Audio/1.mp3');
// music.play();
...
const song = [
    {
        ...
        songName: `ONCE UPON A TIME<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/1.jpg"
    },
    {
        id: 2,
        songName: `DYNASTY<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/2.jpg"
    },
    {
        id: 3,
        songName: `DUST TILL DAWN<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/3.jpg"
    },
    {
        id: 4,
        songName: `7 RINGS x IN YOUR EYES<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/4.jpg"
    },
    {
        id: 5,
        songName: `THE HILLS x WHERE HAVE YOU BEEN<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/5.jpg"
    },
    {
        id: 6,
        songName: `THE OCEAN x WALK THRU FIRE<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/6.jpg"
    },
    {
        id: 7,
        songName: `OBLIVION<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/7.jpg"
    },
    {
        id: 8,
        songName: `ALL FOR LOVE<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/8.jpg"
    },
    {
        id: 9,
        songName: `STEREO HEARTS x POKER FACE<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/9.jpg"
    },
    {
        id: 10,
        songName: `RASPUTIN<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/10.jpg"
    },
    {
        id: 11,
        songName: `LIGHT IT UP x RISE<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/11.jpg"
    },
    {
        id: 12,
        songName: `GENIUS<br>
                   <div class="subtitle">THEREON REMIX</div>`,
        poster: "../../Media/Remix/Thereon/Img/12.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Remix/Thereon/Audio/${index}.mp3`;
        poster.src =`../../Media/Remix/Thereon/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Remix/Thereon/Audio/${index}.mp3`;
