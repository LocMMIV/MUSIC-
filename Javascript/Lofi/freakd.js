...
//---------- Playlist
const music = new Audio('../../Media/Lofi/Freak_D/Audio/1.mp3');
// music.play();
...
const song = [
    {
        ...
        songName: `NHƯ ANH ĐÃ THẤY EM<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CHẲNG THỂ TÌM ĐƯỢC EM<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/2.jpg"
    },
    {
        id: 3,
        songName: `NỢ AI ĐÓ LỜI XIN LỖI 2<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/3.jpg"
    },
    {
        id: 4,
        songName: `NỢ AI ĐÓ LỜI XIN LỖI<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/4.jpg"
    },
    {
        id: 5,
        songName: `NHỮNG GÌ ANH NÓI<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/5.jpg"
    },
    {
        id: 6,
        songName: `LỠ MAI NÀY<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/6.jpg"
    },
    {
        id: 7,
        songName: `NƠI ĐÂY ANH CHỜ EM<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/7.jpg"
    },
    {
        id: 8,
        songName: `ANH SẼ QUÊN EM MÀ<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/8.jpg"
    },
    {
        id: 9,
        songName: `ÔM EM LẦN CUỐI<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/9.jpg"
    },
    {
        id: 10,
        songName: `CHUYỆN ĐÔI TA<br>
                   <div class="subtitle">FREAK D</div>`,
        poster: "../../Media/Lofi/Freak_D/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Lofi/Freak_D/Audio/${index}.mp3`;
        poster.src =`../../Media/Lofi/Freak_D/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Lofi/Freak_D/Audio/${index}.mp3`;
