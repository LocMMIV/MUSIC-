...
//---------- Playlist
const music = new Audio('../../Media/Lofi/Quanvrox/Audio/1.mp3');
// music.play();
...
const song = [
    {
        ...
        songName: `ĐƯỜNG TÔI CHỞ EM VỀ<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/1.jpg"
    },
    {
        id: 2,
        songName: `THƯƠNG NGƯỜI KHÔNG THƯƠNG<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/2.jpg"
    },
    {
        id: 3,
        songName: `GÕ CỬA TRÁI TIM<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/3.jpg"
    },
    {
        id: 4,
        songName: `MỘT LẦN DANG DỞ<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/4.jpg"
    },
    {
        id: 5,
        songName: `SẦU TÍM THIỆP HỒNG<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/5.jpg"
    },
    {
        id: 6,
        songName: `LẠI NHỚ NGƯỜI YÊU<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/6.jpg"
    },
    {
        id: 7,
        songName: `HỎI VỢ NGOÀI HÀNH<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/7.jpg"
    },
    {
        id: 8,
        songName: `HẸN EM KIẾP SAU<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/8.jpg"
    },
    {
        id: 9,
        songName: `PHẬN TÀN<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/9.jpg"
    },
    {
        id: 10,
        songName: `THÌ THÔI<br>
                   <div class="subtitle">QUANVROX</div>`,
        poster: "../../Media/Lofi/Quanvrox/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Lofi/Quanvrox/Audio/${index}.mp3`;
        poster.src =`../../Media/Lofi/Quanvrox/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Lofi/Quanvrox/Audio/${index}.mp3`;
