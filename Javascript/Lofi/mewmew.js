...
//---------- Playlist
const music = new Audio('../../Media/Lofi/MewMew/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `LƯU LUYẾN SAU CHIA TAY<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/1.jpg"
    },
    {
        id: 2,
        songName: `BA KIẾP TÌNH MỘT KIẾP DUYÊN<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/2.jpg"
    },
    {
        id: 3,
        songName: `RƯỢU MỪNG HÓA NGƯỜI DƯNG<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/3.jpg"
    },
    {
        id: 4,
        songName: `LÝ DO LÀ GÌ<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/4.jpg"
    },
    {
        id: 5,
        songName: `EM LÀ NHẤT MIỀN TÂY<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/5.jpg"
    },
    {
        id: 6,
        songName: `ANH NÊN YÊU CÔ ẤY<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/6.jpg"
    },
    {
        id: 7,
        songName: `YÊU THƯƠNG LÀ BÃO TỐ<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/7.jpg"
    },
    {
        id: 8,
        songName: `NHÓI LÒNG THUYỀN HOA<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/8.jpg"
    },
    {
        id: 9,
        songName: `CHƯA BAO GIỜ EM QUÊN<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/9.jpg"
    },
    {
        id: 10,
        songName: `DUYÊN DUYÊN SỐ SỐ<br>
                   <div class="subtitle">MEWMEW</div>`,
        poster: "../../Media/Lofi/MewMew/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Lofi/MewMew/Audio/${index}.mp3`;
        poster.src =`../../Media/Lofi/MewMew/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Lofi/MewMew/Audio/${index}.mp3`;
