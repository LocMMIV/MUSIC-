...
//---------- Playlist
const music = new Audio('../../Media/Rap/Den_Vau/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `ANH ĐẾCH CẦN GÌ NHIỀU NGOÀI EM<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/1.jpg"
    },
    {
        id: 2,
        songName: `BÀI NÀY CHILL PHẾT<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/2.jpg"
    },
    {
        id: 3,
        songName: `ĐI VỀ NHÀ<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/3.jpg"
    },
    {
        id: 4,
        songName: `ĐỐ EM BIẾT ANH ĐANG NGHĨ GÌ<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/4.jpg"
    },
    {
        id: 5,
        songName: `HAI TRIỆU NĂM<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/5.jpg"
    },
    {
        id: 6,
        songName: `LỐI NHỎ<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/6.jpg"
    },
    {
        id: 7,
        songName: `MỘT TRIỆU LIKE<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/7.jpg"
    },
    {
        id: 8,
        songName: `MƯỜI NĂM<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/8.jpg"
    },
    {
        id: 9,
        songName: `NẤU CHO EM ĂN<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/9.jpg"
    },
    {
        id: 10,
        songName: `TRỐN TÌM<br>
                   <div class="subtitle">ĐEN VÂU</div>`,
        poster: "../../Media/Rap/Den_Vau/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Rap/Den_Vau/Audio/${index}.mp3`;
        poster.src =`../../Media/Rap/Den_Vau/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Rap/Den_Vau/Audio/${index}.mp3`;
