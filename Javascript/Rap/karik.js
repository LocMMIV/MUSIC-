...
//---------- Playlist
const music = new Audio('../../Media/Rap/Karik/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `ANH LÀ CỦA EM<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CẠN CẢ NƯỚC MẮT<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/2.jpg"
    },
    {
        id: 3,
        songName: `ĐÀN ÔNG KHÔNG NÓI<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/3.jpg"
    },
    {
        id: 4,
        songName: `ĐAU VẬY ĐỦ RỒI<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/4.jpg"
    },
    {
        id: 5,
        songName: `KHÓC MỘT MÌNH<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/5.jpg"
    },
    {
        id: 6,
        songName: `NGƯỜI LẠ ƠI<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/6.jpg"
    },
    {
        id: 7,
        songName: `TẤT CẢ TẠI ANH<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/7.jpg"
    },
    {
        id: 8,
        songName: `TỪNG LÀ TẤT CẢ<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/8.jpg"
    },
    {
        id: 9,
        songName: `THƯƠNG<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/9.jpg"
    },
    {
        id: 10,
        songName: `VÔ THƯỜNG<br>
                   <div class="subtitle">KARIK</div>`,
        poster: "../../Media/Rap/Karik/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Rap/Karik/Audio/${index}.mp3`;
        poster.src =`../../Media/Rap/Karik/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Rap/Karik/Audio/${index}.mp3`;
