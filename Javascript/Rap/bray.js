...
//---------- Playlist
const music = new Audio('../../Media/Rap/B_Ray/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `BÍ MẬT NHỎ<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CAO ỐC 20<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/2.jpg"
    },
    {
        id: 3,
        songName: `CHO BA<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/3.jpg"
    },
    {
        id: 4,
        songName: `DO FOR LOVE<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/4.jpg"
    },
    {
        id: 5,
        songName: `EX'S HATE ME 1<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/5.jpg"
    },
    {
        id: 6,
        songName: `EX'S HATE ME 2<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/6.jpg"
    },
    {
        id: 7,
        songName: `HOÀN HẢO<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/7.jpg"
    },
    {
        id: 8,
        songName: `LỬNG LƠ<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/8.jpg"
    },
    {
        id: 9,
        songName: `XIN ĐỪNG NHẤC MÁY<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/9.jpg"
    },
    {
        id: 10,
        songName: `YÊU NHƯ TRẺ CON<br>
                   <div class="subtitle">B RAY</div>`,
        poster: "../../Media/Rap/B_Ray/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Rap/B_Ray/Audio/${index}.mp3`;
        poster.src =`../../Media/Rap/B_Ray/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Rap/B_Ray/Audio/${index}.mp3`;
