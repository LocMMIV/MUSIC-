...
//---------- Playlist
const music = new Audio('../../Media/Rap/Justatee/Audio/1.mp3');
// music.play();
...
const song = [
    {
        ...
        poster: "../../Media/Rap/Justatee/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CRYING OVER YOU<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/2.jpg"
    },
    {
        id: 3,
        songName: `CUỘC GỌI CUỐI<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/3.jpg"
    },
    {
        id: 4,
        songName: `ĐÃ LỠ YÊU EM NHIỀU<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/4.jpg"
    },
    {
        id: 5,
        songName: `EZ PAPA<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/5.jpg"
    },
    {
        id: 6,
        songName: `FOREVER ALONE<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/6.jpg"
    },
    {
        id: 7,
        songName: `LỜI NÓI DỐI CHÂN THẬT<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/7.jpg"
    },
    {
        id: 8,
        songName: `NGỌN NẾN TRƯỚC GIÓ<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/8.jpg"
    },
    {
        id: 9,
        songName: `NGƯỜI NÀO ĐÓ<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/9.jpg"
    },
    {
        id: 10,
        songName: `THẰNG ĐIÊN<br>
                   <div class="subtitle">JUSTATEE</div>`,
        poster: "../../Media/Rap/Justatee/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Rap/Justatee/Audio/${index}.mp3`;
        poster.src =`../../Media/Rap/Justatee/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Rap/Justatee/Audio/${index}.mp3`;
