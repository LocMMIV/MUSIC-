...
//---------- Playlist
const music = new Audio('../../Media/Rap/MCK/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `SHOW ME LOVE<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/1.jpg"
    },
    {
        id: 2,
        songName: `SODA<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/2.jpg"
    },
    {
        id: 3,
        songName: `SUIT AND TIE<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/3.jpg"
    },
    {
        id: 4,
        songName: `TẠI VÌ SAO<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/4.jpg"
    },
    {
        id: 5,
        songName: `TAY TO<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/5.jpg"
    },
    {
        id: 6,
        songName: `TỐI NAY ĐI ĐÂU NHỜ<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/6.jpg"
    },
    {
        id: 7,
        songName: `THÔI EM ĐỪNG ĐI<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/7.jpg"
    },
    {
        id: 8,
        songName: `THỜ ER<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/8.jpg"
    },
    {
        id: 9,
        songName: `VA VÀO GIAI ĐIỆU NÀY<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/9.jpg"
    },
    {
        id: 10,
        songName: `XÍCH THÊM CHÚT<br>
                   <div class="subtitle">MCK</div>`,
        poster: "../../Media/Rap/MCK/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Rap/MCK/Audio/${index}.mp3`;
        poster.src =`../../Media/Rap/MCK/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Rap/MCK/Audio/${index}.mp3`;
