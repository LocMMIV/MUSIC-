...
//---------- Playlist
const music = new Audio('../../Media/Ballad/Huong_Ly/Audio/1.mp3');
// music.play();
...
const song = [
    {
        ...
        poster: "../../Media/Ballad/Huong_Ly/Img/1.jpg"
    },
    {
        id: 2,
        songName: `THIỆP HỒNG NGƯỜI DƯNG<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/2.jpg"
    },
    {
        id: 3,
        songName: `CÔ THẮM KHÔNG VỀ<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/3.jpg"
    },
    {
        id: 4,
        songName: `HỌA MÂY<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/4.jpg"
    },
    {
        id: 5,
        songName: `THẾ THÁI<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/5.jpg"
    },
    {
        id: 6,
        songName: `CỐ GIANG TÌNH<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/6.jpg"
    },
    {
        id: 7,
        songName: `PHỤ SUYÊN<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/7.jpg"
    },
    {
        id: 8,
        songName: `HÀNH LANG CŨ<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/8.jpg"
    },
    {
        id: 9,
        songName: `CHẮC GÌ ANH YÊU CÔ ẤY<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/9.jpg"
    },
    {
        id: 10,
        songName: `VUI LẮM NHA<br>
                   <div class="subtitle">HƯƠNG LY</div>`,
        poster: "../../Media/Ballad/Huong_Ly/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Ballad/Huong_Ly/Audio/${index}.mp3`;
        poster.src =`../../Media/Ballad/Huong_Ly/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Ballad/Huong_Ly/Audio/${index}.mp3`;
