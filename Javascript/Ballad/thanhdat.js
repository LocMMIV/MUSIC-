...
//---------- Playlist
const music = new Audio('../../Media/Ballad/Thanh_Dat/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `NGÀY MAI NGƯỜI TA LẤY CHỒNG<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/1.jpg"
    },
    {
        id: 2,
        songName: `SAO CŨNG ĐƯỢC<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/2.jpg"
    },
    {
        id: 3,
        songName: `TA NỢ NHAU LỜI XIN LỖI<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/3.jpg"
    },
    {
        id: 4,
        songName: `LẠC TRONG KÝ ỨC<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/4.jpg"
    },
    {
        id: 5,
        songName: `BẦU TRỜI CỦA BIỂN<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/5.jpg"
    },
    {
        id: 6,
        songName: `CHỈ LÀ ĐÃ TỪNG<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/6.jpg"
    },
    {
        id: 7,
        songName: `YÊU NGƯỜI ĐẾN SAU<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/7.jpg"
    },
    {
        id: 8,
        songName: `EM À ANH ĐAU LẮM<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/8.jpg"
    },
    {
        id: 9,
        songName: `1001 LÝ DO<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/9.jpg"
    },
    {
        id: 10,
        songName: `CHẲNG GÌ LÀ MÃI MÃI<br>
                   <div class="subtitle">THÀNH ĐẠT</div>`,
        poster: "../../Media/Ballad/Thanh_Dat/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Ballad/Thanh_Dat/Audio/${index}.mp3`;
        poster.src =`../../Media/Ballad/Thanh_Dat/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Ballad/Thanh_Dat/Audio/${index}.mp3`;
