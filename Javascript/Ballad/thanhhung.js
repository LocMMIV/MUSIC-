...
//---------- Playlist
const music = new Audio('../../Media/Ballad/Thanh_Hung/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `AI ĐỢI MÌNH ĐƯỢC MÃI<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CẦN KHÔNG CÓ CÓ KHÔNG CẦN<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/2.jpg"
    },
    {
        id: 3,
        songName: `CHẮC VÌ MÌNH CHƯA TỐT<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/3.jpg"
    },
    {
        id: 4,
        songName: `YÊU KHÁC THƯƠNG HẠI<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/4.jpg"
    },
    {
        id: 5,
        songName: `EM MUỐN TA LÀ GÌ<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/5.jpg"
    },
    {
        id: 6,
        songName: `KỶ NIỆM GIAM CẦM CHÚNG TA<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/6.jpg"
    },
    {
        id: 7,
        songName: `SAI NGƯỜI SAI THỜI ĐIỂM<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/7.jpg"
    },
    {
        id: 8,
        songName: `TẾT NÀY CON KHÔNG VỀ<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/8.jpg"
    },
    {
        id: 9,
        songName: `THAY TÔI YÊU CÔ ẤY<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/9.jpg"
    },
    {
        id: 10,
        songName: `VẠN SỰ TÙY DUYÊN<br>
                   <div class="subtitle">THANH HƯNG</div>`,
        poster: "../../Media/Ballad/Thanh_Hung/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Ballad/Thanh_Hung/Audio/${index}.mp3`;
        poster.src =`../../Media/Ballad/Thanh_Hung/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Ballad/Thanh_Hung/Audio/${index}.mp3`;
