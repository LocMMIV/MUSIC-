...
//---------- Playlist
const music = new Audio('../../Media/Ballad/Mr_Siro/Audio/1.mp3');
// music.play();
...
const song = [
    {
        ...
        poster: "../../Media/Ballad/Mr_Siro/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CHẠM ĐÁY NỖI ĐAU<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/2.jpg"
    },
    {
        id: 3,
        songName: `ĐỪNG AI NHẮC VỀ CÔ ẤY<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/3.jpg"
    },
    {
        id: 4,
        songName: `YÊU MỘT NGƯỜI VÔ TÂM<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/4.jpg"
    },
    {
        id: 5,
        songName: `NGUYỆN LÀM TRI KỈ<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/5.jpg"
    },
    {
        id: 6,
        songName: `KHÔNG THỂ CÙNG NHAU SUỐT KIẾP<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/6.jpg"
    },
    {
        id: 7,
        songName: `CÁNH ĐỒNG YÊU THƯƠNG<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/7.jpg"
    },
    {
        id: 8,
        songName: `TRÁI TIM ANH CŨNG BIẾT ĐAU<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/8.jpg"
    },
    {
        id: 9,
        songName: `XUÂN NÀY CON KHÔNG VỀ<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/9.jpg"
    },
    {
        id: 10,
        songName: `GƯƠNG MẶT LẠ LẪM<br>
                   <div class="subtitle">MR SIRO</div>`,
        poster: "../../Media/Ballad/Mr_Siro/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Ballad/Mr_Siro/Audio/${index}.mp3`;
        poster.src =`../../Media/Ballad/Mr_Siro/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Ballad/Mr_Siro/Audio/${index}.mp3`;
