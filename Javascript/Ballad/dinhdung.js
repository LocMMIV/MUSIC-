...
//---------- Playlist
const music = new Audio('../../Media/Ballad/Dinh_Dung/Audio/1.mp3');
// music.play();

const song = [
    {
        id: 1,
        songName: `ĐỪNG HẸN KIẾP SAU<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/1.jpg"
    },
    {
        id: 2,
        songName: `CÂU HẸN CÂU THỀ<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/2.jpg"
    },
    {
        id: 3,
        songName: `ANH KHÔNG THA THỨ<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/3.jpg"
    },
    {
        id: 4,
        songName: `TÌNH ANH<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/4.jpg"
    },
    {
        id: 5,
        songName: `SAI LẦM CỦA ANH<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/5.jpg"
    },
    {
        id: 6,
        songName: `ANH THƯƠNG EM CÒN NON DẠI<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/6.jpg"
    },
    {
        id: 7,
        songName: `NẾU PHẢI MẤT NHAU<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/7.jpg"
    },
    {
        id: 8,
        songName: `NGƯỜI THƯƠNG EM LÀ AI<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/8.jpg"
    },
    {
        id: 9,
        songName: `ĐỪNG NÓI<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/9.jpg"
    },
    {
        id: 10,
        songName: `TÌNH DANG DỞ<br>
                   <div class="subtitle">ĐÌNH DŨNG</div>`,
        poster: "../../Media/Ballad/Dinh_Dung/Img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `../../Media/Ballad/Dinh_Dung/Audio/${index}.mp3`;
        poster.src =`../../Media/Ballad/Dinh_Dung/Img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play');
        masterPlay.classList.add('bi-pause');
        download_music.href = `../../Media/Ballad/Dinh_Dung/Audio/${index}.mp3`;
